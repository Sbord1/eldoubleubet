...
<body>
    ...
    <h3 style="text-align: center; color: white;">Seleziona una categoria dal men&ugrave; in basso per guardare le scommesse proposte dagli utenti.</h3>

    <nav>
      <ul>
        <li>
            <form method="post" action="approvaScommessaSport.php">
