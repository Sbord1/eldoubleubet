...
// Se richiedo di ricaricare inserisco la richiesta all'interno del file xml dedicato
	if (isset($_POST['invio'])){
	   ...
	   if (!$doc->loadXML($xmlString)) {
		...
		$proposteScommessaBasket = $doc->documentElement; //root
		$lunghezza = $proposteScommessaBasket->childNodes->length;  //lunghezza corrisponde a quante richieste ci sono
		...
		$proposteScommessa->appendChild($quotaBasket);
		...
		$proposteScommessaBasket->appendChild($proposteScommessa);
...
<head>
  ...
  <title>Proponi scommessa Basket</title>
  <style>
